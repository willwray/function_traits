...
template <typename F>
inline constexpr bool is_free_function_v = std::is_function_v<F>
             && !std::is_same_v<F,std::add_lvalue_reference_t<F>>;
...
#define X(QUAL)                                                                \
  template <typename F> struct function_is_##QUAL : function<F>::is_##QUAL {}; \
  template <typename F>                                                        \
...
using function_set_volatile_t =
    typename function<F>::template set_volatile_t<V>;
...
using function_set_reference_t =
    typename function<F>::template set_reference_t<R>;
...
using function_set_noexcept_t =
    typename function<F>::template set_noexcept_t<N>;
...
using function_set_variadic_t =
    typename function<F>::template set_variadic_t<A>;
...
using function_set_return_type_t =
    typename function<F>::template set_return_type_t<T>;
...
using function_signature_noexcept_t =
    typename function<F>::signature_noexcept_t;
template <typename F>
...
using function_set_signature_t =
    typename function<F>::template set_signature_t<S>;
